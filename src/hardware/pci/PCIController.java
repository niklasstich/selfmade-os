...
public class PCIController {
	...
	private static PCIDevice getFunctionRegisters(byte bus, byte dev, byte func) {
		...
		//process data
		PCIDevice retval = new PCIDevice((reg0&0xFFFF0000)>>16, (reg0&0x0000FFFF), (reg1&0xFFFF0000)>>16, (reg1&0x0000FFFF),
				(reg2&0xFF000000)>>24, (reg2&0x00FF0000)>>16, (reg2&0x0000FF00)>>8, (reg2&0x000000FF),
				(reg3&0xFF000000)>>24, (reg3&0x00FF0000)>>16, (reg3&0x0000FF00)>>8, (reg3&0x000000FF), bus, dev, func);
		return retval;
	}
	...
	public static PCIDevice[] getRecognizedDevices() {
		if (recognizedDevices==null) recognizeDevices();
