...
class GetPCIDevices extends Executable {
	...
	"display controller", "multimedia device", "memory controller", "bridge", "communication controller",
	...
	public int execute() {
		...
		Console.print("");Console.print("");Console.print('\n');
		for (int i = 0; i < devs.length; i++) {
			PCIDevice dev = devs[i];
			Console.print(i); Console.print(":      ");
			Console.print(dev.bus); Console.print(",   ");
			Console.print(dev.device); Console.print(",   ");
			Console.print(dev.function); Console.print(",    ");
			Console.print(baseClassCodes[dev.baseClass]); Console.print(", ");
			Console.printHex(dev.subClass); Console.print(", ");
