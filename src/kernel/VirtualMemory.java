...
public class VirtualMemory {
	...
	private static void writePageDirectoryAndTable() {
		...
		pt = (PageTable) DynamicRuntime.newInstance(MAGIC.getInstScalarSize("PageTable")+1024*1024*4,
				MAGIC.getInstRelocEntries("PageTable"), (SClassDesc) MAGIC.clssDesc("PageTable"));
